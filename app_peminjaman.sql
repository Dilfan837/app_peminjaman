...
--
-- Host: localhost:3306
-- Generation Time: Oct 10, 2024 at 04:49 AM
...
--
-- Table structure for table `td_peminjam_barang`
--

CREATE TABLE `td_peminjam_barang` (
...
--
-- Indexes for table `td_peminjam_barang`
--
ALTER TABLE `td_peminjam_barang`
...
--
-- Constraints for table `td_peminjam_barang`
--
ALTER TABLE `td_peminjam_barang`
  ADD CONSTRAINT `td_peminjam_barang_ibfk_1` FOREIGN KEY (`br_kode`) REFERENCES `tm_barang_inventaris` (`br_kode`),
  ADD CONSTRAINT `td_peminjam_barang_ibfk_2` FOREIGN KEY (`pb_id`) REFERENCES `peminjaman` (`pb_id`);
